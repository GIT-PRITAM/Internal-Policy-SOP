    ...
    <AppLayout>
      <div className="space-y-6">
        <div>
          ...
          <div className="text-slate-400 mt-1">Account and workspace preferences.</div>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-soft">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              ...
              <div className="text-slate-400 mt-1">alex@company.com</div>
            ...
            <div className="text-right">
              ...
              <div className="mt-2 rounded-xl border border-white/10 bg-slate-950/20 p-3 text-sm text-slate-200">2FA Enabled</div>
            </div>
          </div>

          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-xl border border-white/10 bg-slate-950/20 p-4">
              <div className="text-sm text-slate-400">Default workspace</div>
              <div className="mt-1 font-medium">PolicyOps Enterprise</div>
            </div>
            <div className="rounded-xl border border-white/10 bg-slate-950/20 p-4">
