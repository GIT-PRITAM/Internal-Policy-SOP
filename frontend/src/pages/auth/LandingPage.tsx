              ...
              >
                ...
                <div className="lg:col-span-6">
                  ...
                  <p className="mt-4 max-w-xl text-slate-300 leading-relaxed">
                    Securely create, review, and acknowledge internal policies
                    with role-based visibility, version history, and audit-ready
                    workflows.
                  </p>
                  ...
                  <div className="mt-7 flex flex-col sm:flex-row items-start sm:items-center gap-3">
                    ...
                    >
                      <span className="text-base">Login Here</span>
                      <span aria-hidden className="text-white/90 font-bold">
                        →
                      </span>
                    </button>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div className="text-left">
                        ...
                        <div className="mt-1 text-xs text-slate-400">
                          By continuing, you acknowledge governance policies and
